<x-guest-layout>
    ...
    <div class="flex flex-col items-center text-center mb-5 space-y-1">
        ...
        <p class="text-2xs text-slate-500 max-w-xs leading-relaxed">
            Mulai pengalaman cetak online Anda dengan cepat dan mudah
        </p>
    </div>
    ...
    <form id="register-form"
        ...
        {{-- ── Name Input ── --}}
        <div class="space-y-1">
            <label for="name" class="block text-xs font-bold text-slate-700 tracking-wide">
                Nama Lengkap
            </label>
            <div class="relative">
                <input id="name"
        ...
        <div class="space-y-1">
            <label for="password_confirmation" class="block text-xs font-bold text-slate-700 tracking-wide">
            ...
            <div class="relative">
                ...
                <button type="button"
                        ...
                        class="absolute inset-y-0 right-0 flex items-center pr-4 text-slate-400 hover:text-slate-600 transition-colors focus:outline-none">
                    <svg x-show="!showConfirmPass" class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                    </svg>
                    <svg x-show="showConfirmPass" x-cloak class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 01-1.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"/>
                    </svg>
                </button>
            </div>
        ...
        <div class="flex items-start gap-2.5 pt-0.5">
            <input id="terms"
                   ...
                   name="terms"
                   required
                   class="mt-0.5 h-4 w-4 rounded border-slate-300 text-orange-500
                          focus:ring-2 focus:ring-orange-500 focus:ring-offset-0
                          transition-colors duration-150 cursor-pointer">
            <label for="terms"
                   class="cursor-pointer select-none text-xs font-medium text-slate-600 hover:text-slate-800 transition-colors duration-150 leading-relaxed">
                Saya menyetujui <span class="font-bold text-orange-500 hover:underline">Syarat & Ketentuan</span> serta <span class="font-bold text-orange-500 hover:underline">Kebijakan Privasi</span>
            </label>
        </div>
