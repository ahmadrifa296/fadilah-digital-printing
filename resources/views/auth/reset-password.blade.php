<x-guest-layout>
    ...
    <div class="flex flex-col items-center text-center mb-5 space-y-1">
        ...
        <p class="text-2xs text-slate-500 max-w-xs leading-relaxed">
            Buat kata sandi baru yang aman dan mudah diingat untuk akun Anda
        </p>
    </div>
        ...
        <div class="space-y-1">
            ...
            <div class="relative">
                <input id="email"
                       ...
                       required
                       readonly
                       class="w-full rounded-2xl border py-3 px-4 text-xs bg-slate-100 border-slate-200 text-slate-500 cursor-not-allowed focus:outline-none">
            </div>
            @error('email')
        ...
        <div class="space-y-1">
            ...
            <div class="relative">
                <input id="password_confirmation"
                       ...
                       required
                       autocomplete="new-password"
                       placeholder="Konfirmasikan kata sandi baru"
                       class="w-full rounded-2xl border py-3 pl-4 pr-12 text-xs transition-all duration-200
                              placeholder-slate-400 text-slate-900 bg-slate-50/50
                              focus:bg-white focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500
